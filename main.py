...
def main():
    ...
    """
    Description:
        Trains and tests our Perceptron Algorithm
    ...
    pcp = Perceptron(epochs = epochs, lr = lr)
    ...
    pcp_decision = Perceptron(epochs = epochs, lr = lr)
    pcp_decision.fit(X, y)
    ...
    visualize_decision_boundary(X = X[:, [0, 1]], y = y, model = pcp_decision, title = title_boundary, x_label = 'Feature 1',
                                y_label = 'Feature 2', class_names = class_names ,resolution = resolution,
    ...
    visualize_decision_boundary(X = X[:, [0, 1]], y = y, model = pcp_decision, title = title_boundary, x_label = feature_names[0],
    ...
    visualize_decision_boundary(X = X[:, [5, 6]], y = y, model = pcp_decision, title = title_boundary, x_label = feature_1,
